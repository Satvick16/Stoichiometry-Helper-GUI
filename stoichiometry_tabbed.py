...
frame_1 = tk.Frame(my_notebook, width=window.winfo_screenwidth(), height=window.winfo_screenheight())
frame_2 = tk.Frame(my_notebook, width=window.winfo_screenwidth(), height=window.winfo_screenheight())

frame_1.grid()
frame_2.grid()

my_notebook.add(frame_1, text="Mass Stoichiometry")
my_notebook.add(frame_2, text="Mass Spectrometry and Element Explorer")
...
def description():
    ...
    d = tk.Text(master=frame_2, width=50, height=7)
...
chemicals = tk.Label(frame_1, text="Unbalanced Chemical Equation:", font=("Segoe UI", 10, 'bold'))
chemicals.grid(row=0, column=0, pady=(30, 30))
MR = tk.Label(frame_1, text="Molar Ratio/Coefficients (MR):", font=("Segoe UI", 10, 'bold'))
MR.grid(row=1, column=0, pady=(30, 30))
m = tk.Label(frame_1, text="Mass (g):", font=("Segoe UI", 10, 'bold'))
m.grid(row=2, column=0, pady=(30, 30))
n = tk.Label (frame_1, text="Moles (mol):", font=("Segoe UI", 10, 'bold'))
n.grid(row=3, column=0, pady=(30, 30))
Mm = tk.Label(frame_1, text="Molar Mass (g/mol)", font=("Segoe UI", 10, 'bold'))
Mm.grid(row=4, column=0, pady=(30, 30))

plus1 = tk.Label(frame_1, text="+", font=("Segoe UI", 10, 'bold'))
plus1.grid(row=0, column=2)
plus2 = tk.Label(frame_1, text="+", font=("Segoe UI", 10, 'bold'))
plus2.grid(row=0, column=6)
arrow = tk.Label(frame_1, text="---->", font=("Segoe UI", 10, 'bold'))
arrow.grid(row=0, column=4)

colon1 = tk.Label(frame_1, text=":", font=("Segoe UI", 10, 'bold'))
colon1.grid(row=1, column=2)
colon2 = tk.Label(frame_1, text=":", font=("Segoe UI", 10, 'bold'))
colon2.grid(row=1, column=4)
colon3 = tk.Label(frame_1, text=":", font=("Segoe UI", 10, 'bold'))
colon3.grid(row=1, column=6)

# ---- ENTRY FIELDS ----

get_chemical1 = tk.Entry(frame_1)
get_chemical1.grid(row=0, column=1)
get_chemical2 = tk.Entry(frame_1)
get_chemical2.grid(row=0, column=3)
get_chemical3 = tk.Entry(frame_1)
get_chemical3.grid(row=0, column=5)
get_chemical4 = tk.Entry(frame_1)
get_chemical4.grid(row=0, column=7, padx=(0, 20))

getMR1 = tk.Entry(frame_1)
getMR1.grid(row=1, column=1)
getMR2 = tk.Entry(frame_1)
getMR2.grid(row=1, column=3)
getMR3 = tk.Entry(frame_1)
getMR3.grid(row=1, column=5)
getMR4 = tk.Entry(frame_1)
getMR4.grid(row=1, column=7, padx=(0, 20))

# .insert adds a default value to the entry field
getm1 = tk.Entry(frame_1)
getm1.insert(0, 0.0)
getm1.grid(row=2, column=1)
getm2 = tk.Entry(frame_1)
getm2.insert(0, 0.0)
getm2.grid(row=2, column=3)
getm3 = tk.Entry(frame_1)
getm3.insert(0, 0.0)
getm3.grid(row=2, column=5)
getm4 = tk.Entry(frame_1)
getm4.insert(0, 0.0)
getm4.grid(row=2, column=7, padx=(0, 20))

getn1 = tk.Entry(frame_1)
getn1.insert(0, 0.0)
getn1.grid(row=3, column=1)
getn2 = tk.Entry(frame_1)
getn2.insert(0, 0.0)
getn2.grid(row=3, column=3)
getn3 = tk.Entry(frame_1)
getn3.insert(0, 0.0)
getn3.grid(row=3, column=5)
getn4 = tk.Entry(frame_1)
getn4.insert(0, 0.0)
getn4.grid(row=3, column=7, padx=(0, 20))

getMm1 = tk.Entry(frame_1)
getMm1.insert(0, 0.0)
getMm1.grid(row=4, column=1)
getMm2 = tk.Entry(frame_1)
getMm2.insert(0, 0.0)
getMm2.grid(row=4, column=3)
getMm3 = tk.Entry(frame_1)
getMm3.insert(0, 0.0)
getMm3.grid(row=4, column=5)
getMm4 = tk.Entry(frame_1)
getMm4.insert(0, 0.0)
getMm4.grid(row=4, column=7, padx=(0, 20))

get_element = tk.Entry(frame_2, width=60)
get_element.grid(row=4, column=9, padx=(150, 50))

# ---- BUTTONS ----

submit = tk.Button(frame_1, text="Calculate", command=done, height=1, width=8, bg="#c8c8c8", font=("Segoe UI", 10))\
    .grid(row=5, column=7, pady=(0, 20))

# vertical line
# tk.ttk.Separator(window, orient='vertical').grid(column=8, row=0, rowspan=10, sticky='ns')

desc = tk.Button(frame_2, text="^^^ Get description of the element entered above ^^^", command=description, bg="#c8c8c8",
